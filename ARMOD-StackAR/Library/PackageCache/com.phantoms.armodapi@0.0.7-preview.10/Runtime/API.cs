...
namespace com.Phantoms.ARMODAPI.Runtime
{
    public class API
    {
        ...
        public void LoadGameObject(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadTexture2D(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadSpriteAtlas(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadAudioClip(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadVideoClip(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadTextAsset(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadFont(string _wannaLoadedAssetName,
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadAnimationClip(string _wannaLoadedAssetName,
        ...
        public void LoadAsset<T>(string _wannaLoadedAssetName, Action<T> _loadedCallback)
        ...
        public async Task<T> LoadAssetAsync<T>(string _wannaLoadedAssetName)
            where T : UnityEngine.Object
        {
        ...
        /// <param name="_wannaLoadedAssetName">you wanna load asset name</param>
        /// <param name="_loadedCallback">call back when loaded</param>
        public void LoadMaterial(string _wannaLoadedAssetName,
        ...
        [Obsolete("Obsoleted. use Object.Instantiate",true)]
